...
const FAQ = () => {
    ...
    return (
        <div className='mt-5' style={{marginLeft: "20px", marginRight: "20px"}}>
            <Title title="FAQ">FREQUENTLY ASKED QUESTION</Title>
            <div style={{marginBottom: "100px"}}>
                <ul className="nav my-2 row">
                    <li className="nav-item col-6">
                        <a className="nav-link active text-center text-white fw-bold" style={{width: "150px", padding: "20px 10px", margin: "6px", borderRadius: "30px 30px 30px 0px"}} data-bs-toggle="tab" href="#menu1">
                            <p className='bi bi-virus fs-1'></p>
                            <p>Menu 1</p>
                        </a>
                    </li>
                    <li className="nav-item col-6">
                        <a className="nav-link text-center text-white fw-bold" style={{width: "150px", padding: "20px 10px", margin: "6px", borderRadius: "30px 30px 30px 0px"}} data-bs-toggle="tab" href="#menu2">
                            <p className='bi bi-virus2 fs-1'></p>
                            <p>Menu 2</p>
                        </a>
                    </li>
                    <li className="nav-item col-6">
                        <a className="nav-link text-center text-white fw-bold" style={{width: "150px", padding: "20px 10px", margin: "6px", borderRadius: "30px 30px 30px 0px"}} data-bs-toggle="tab" href="#menu3">
                            <p className='bi bi-virus fs-1'></p>
                            <p>Menu 3</p>
                        </a>
                    </li>
                    <li className="nav-item col-6">
                        <a className="nav-link text-center text-white fw-bold" style={{width: "150px", padding: "20px 10px", margin: "6px", borderRadius: "30px 30px 30px 0px"}} data-bs-toggle="tab" href="#menu4">
                            <p className='bi bi-virus2 fs-1'></p>
                            <p>Menu 4</p>
                        </a>
                    </li>
                    <li className="nav-item col-6">
                        <a className="nav-link text-center text-white fw-bold" style={{width: "150px", padding: "20px 10px", margin: "6px", borderRadius: "30px 30px 30px 0px"}} data-bs-toggle="tab" href="#menu5">
                            <p className='bi bi-virus fs-1'></p>
                            <p>Menu 5</p>
                        </a>
                    </li>
