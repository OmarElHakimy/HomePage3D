...
const leftVariants = {
    fixedLeft: {x:0, opacity: 1, transition: {duration: 0.6}},
        ...
        <div>
            <div style={{marginLeft:"250px", marginRight:"250px", marginBottom: "100px"}}>
                <div className='row' style={{marginTop:"50px", marginBottom:"80px"}}>
                    <motion.div ref={ref} animate={controls} initial="left" variants={leftVariants}  className='col-6'>
                        <div style={{width: "100%", height: "400px"}}>
                            <img src={img1} style={{height: "100%", width: "100%"}}/>
                        </div>
                    </motion.div>
                    <div ref={ref}className='col-6'>
